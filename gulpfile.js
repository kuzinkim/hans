...
gulp.task('build', gulp.series('clean', gulp.parallel('assets', 'html', 'css-build', 'css-libs-build', 'js-build')));

gulp.task('create', gulp.series('clean', gulp.parallel('assets', 'html', 'css', 'css-libs', 'js')));
